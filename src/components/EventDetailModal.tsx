                    ...
                    {renderEvent ? renderEvent(event) : (
                        <div>
                            ...
                            <div className="mt-8 space-y-6">
                                ...
                                {event.customer && (
                                    <div className="flex items-start gap-4 pt-1">
                                        ...
                                        <div className="flex-1 min-w-0 pt-0.5">
                                            ...
                                            {(event.customer.contact || event.customer.phone) && (
                                ...
                                {event.asset && (
                                    <div className="flex items-start gap-4 pt-1">
                                        <div className="w-10 h-10 rounded-xl bg-amber-50 dark:bg-amber-900/30 flex items-center justify-center shrink-0 text-amber-600 dark:text-amber-400 border border-amber-100 dark:border-amber-800">
                                        ...
                                        <div className="flex-1 min-w-0 pt-0.5">
                                            <div className="flex items-center justify-between mb-0.5">
                                                <h3 className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest">Assigned Unit</h3>
                                                {event.asset.licensePlate && (
                                                    <span className="text-[10px] font-bold tracking-widest px-1.5 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800 text-zinc-500 dark:text-zinc-400 border border-zinc-200 dark:border-zinc-700 font-mono">
                                                        {event.asset.licensePlate}
                                                    </span>
                                                )}
                                            </div>
